...
public class MainPageActivity extends Activity {
			...
			public void onClick(View v) {
				...
				if (getString(R.string.start_test).equals(btnTest.getText().toString())) {
					...
					if (adapter.checkedProg != null) {
						...
						monitorService.putExtra("appVersion", appVersion);
	...
	private void initTitleLayout() {
		...
		Settings.serverIp = preferences.getString(Settings.KEY_SERVER_IP, "");
		Settings.serverPort = preferences.getString(Settings.KEY_SERVER_PORT, "");
		if (Settings.serverIp.equals("")) {
			Settings.serverIp = "114.215.153.178";
			Settings.serverPort = "8088";
			Editor editor = preferences.edit();
			editor.putString(Settings.KEY_SERVER_IP, "114.215.153.178");
			editor.putString(Settings.KEY_SERVER_PORT, "8088");
			editor.commit();
		}
	}
