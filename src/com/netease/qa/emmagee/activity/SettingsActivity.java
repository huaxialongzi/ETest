...
public class SettingsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		serverSettings = (LinearLayout) findViewById(R.id.server_settings);
		...
		tvTime.setText(String.valueOf(interval+1));
		...
		serverSettings.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent();
				intent.setClass(SettingsActivity.this, ServerSettingsActivity.class);
				startActivity(intent);
			}
		});
